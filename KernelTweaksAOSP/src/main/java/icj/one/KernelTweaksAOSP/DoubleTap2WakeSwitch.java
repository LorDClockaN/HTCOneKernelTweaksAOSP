...
public class DoubleTap2WakeSwitch implements OnPreferenceChangeListener {
    ...
    /**
     * Restore DoubleTap2Wake setting from SharedPreferences. (Write to kernel.)
    ...
    public static void restore(Context context) {
        ...
        boolean enabled = sharedPrefs.getBoolean(DeviceSettings.KEY_DOUBLETAP2WAKESWITCH, false);
        if(enabled)
